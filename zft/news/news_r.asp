...
<%
   Dim com
   com="Select ID,theme,jdate from 经济新闻"
...
<center>
 ...
 <table width="970" border="0" cellspacing="2" cellpadding="2">
  ...
  <div class="left"><!--#include file="new.asp" --></div>
  <div class="right">
...
<%	 While Not rs.eof
       Response.Write "<tr>"
%>        <td><a href="detail_economic.asp?id=<%= rs("ID") %>" class="channel3"><% Response.Write rs("theme")  %></a></td>
<%        Response.Write "<td>" & rs("jdate") & "</td>"
         rs.movenext
	   Response.Write "</tr>"
     Wend
%>
