...
<%
   ...
   id=Request("id")
   Dim com
   com="Select * from 经济新闻 where ID="&id&""
   Set rs=conn.Execute(com, recordsAffected, adcmdtext)
     If rs.Bof or rs.Eof  Then
       Response.Write ("<script language=javascript>alert('没有经济新闻的信息！');javascript:history.go(-1)</script>")
       Response.End
     End If
%>
<body>
    ...
    <table width="620" border="0" cellpadding="4" cellspacing="4">
      ...
      <tr>
        ...
        <table width="192" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" height="36" background="../image/news3.jpg"  style="font-size:14px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;经济新闻发布</td>
          </tr>
        </table>
        </td>
      </tr>
      ...
      <tr>
        ...
        <table border="0" width="569">
          ...
          <tr>
            <td align="center"><p style="font-size:13px; color:#484848; font-family:Tahoma;"><a href="http://www.zft.com">http://www.zft.com</a>&nbsp;&nbsp;<%= rs("jdate") %>&nbsp;&nbsp;<%= rs("jtime") %></p></td>
          </tr>
          <tr>
            <td><pre style="font-size:13px; color:#484848; font-family:宋体; white-space: normal; word-wrap: break-word; height:480px; line-height:20px"><%= rs("jtext") %></pre></td>
          </tr>
        </table>
        </td>
        </tr>
