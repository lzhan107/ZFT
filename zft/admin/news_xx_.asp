...
<center>
 ...
 <table width="970" border="0" cellspacing="2" cellpadding="2">
    ...
    <tr><td>&nbsp;</td>
      <td>
       <table width="192" border="0" cellspacing="0" cellpadding="0">
        <tr><td align="left" height="36" background="../image/news3.jpg"  style="font-size:14px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;学习活动动态发布</td></tr>
       </table>
      </td>
    </tr>
    <tr>
  ...
  <form name="form1" enctype="multipart/form-data" method="post" action="up_jj.asp">
  <table width="560" border="0" cellspacing="4" cellpadding="4" class="fontstyle1">
    <tr>
      <td width="172"><input type="file" name="File1" size="15"></td>
      <td align="center" width="89">&nbsp;</td><td width="279">&nbsp;</td>
    </tr>
    <tr>
      <td><input type="file" name="File2" size="15"></td>
      <td align="center" background="../image/附件.jpg" style="cursor:hand;" onClick="javascript:form1.submit()">添加附件</td><td>&nbsp;</td>
    </tr>
  </table>
  </form>
  </div>
