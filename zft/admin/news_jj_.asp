...
<center>
 ...
 <table width="970" border="0" cellspacing="2" cellpadding="2">
  ...
  <table width="620" border="0" cellspacing="4" cellpadding="4">
    ...
    <tr><td>&nbsp;</td>
      <td>
       <table width="192" border="0" cellspacing="0" cellpadding="0">
        <tr><td align="left" height="36" background="../image/news3.jpg"  style="font-size:14px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;经济新闻发布</td></tr>
       </table>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>&nbsp;</td>
      <td>发布成功！<a href="../news/news_economic.asp" class="channel1">查看</a></td>
    </tr>
  </table>
  <form action="jj.asp" method="post" name="jj">
    <table width="560" border="0" cellspacing="5" cellpadding="5" align="center">
      ...
      <tr>
        ...
        <td width="334" align="center">
          <img src="../image/发布.jpg" width="55" height="25" style="cursor:hand;" onClick="javascript:jj.submit()">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <img src="../image/重写.jpg" width="55" height="25" style="cursor:hand;" onClick="javascript:jj.reset()">
        </td>
