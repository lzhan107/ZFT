...
<center>
 ...
 <table width="970" border="0" cellspacing="2" cellpadding="2">
  ...
  <form action="xx.asp" method="post" name="xx">
    <table width="560" border="0" cellspacing="5" cellpadding="5" align="center">
      ...
      <tr>
        ...
        <td width="334" align="center">
          <img src="../image/发布.jpg" width="55" height="25" style="cursor:hand;" onClick="javascript:xx.submit()">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <img src="../image/重写.jpg" width="55" height="25" style="cursor:hand;" onClick="javascript:xx.reset()">
          </td>
