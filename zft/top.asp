<table width="970" border="0" cellspacing="2" cellpadding="2">
 <tr>
   <td width="446">&nbsp;</td>
   <td width="510">
    <form action="record_i.asp" method="post" name="form1">    
    <div class="top">
    <table width="497" border="0" cellspacing="2" cellpadding="2" >
     <tr>
      <td width="79"><a href="register/register.asp"><img src="image/reg.jpg" width="78" height="26" border="0"></a></td>
      <td width="70" height="13"><span class="fontstyle1">登录名：</span></td>
      <td width="106"><input name="rname" type="text" size="15" /></td>
      <td width="49"><span class="fontstyle1">密码：</span></td>
      <td width="105"><input name="password" type="password" size="15" /></td>
      <td width="50"><img src="image/button.jpg" width="50" height="26" style="cursor: hand" onclick="javascript:form1.submit();"></td>
     </tr>
    </table>
    </div>   
    </form>
