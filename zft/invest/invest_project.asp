 ...
 <table width="967" border="0" cellspacing="2" cellpadding="0">
   <tr><td>
     <table width="958" border="0" cellpadding="2" cellspacing="0" class="invest">
       <tr>
         <td><img src="../image/invest/m_project.jpg" width="963" height="170"></td>
         </tr>
     </table>
   </td></tr>
 </table>
  <div class="series">
    <table width="900" border="0" cellspacing="4" cellpadding="0" align="center">
     <tr>
       <td height="58" width="205" background="../image/invest/title.jpg" style="font-family:华文彩云; font-size:30px; color:#548DD4" align="center" valign="middle"><p>项目信息</p></td>
       <td width="90">&nbsp;</td><td colspan="4">&nbsp;</td>
       </tr>
     <tr>
       <td>&nbsp;</td>
       <td width="90">&nbsp;</td>
       <td width="180" height="35" align="center" background="../image/invest/all_link.jpg" class="fontstyle1"><a href="invest_message.asp" class="channel1">&nbsp;&nbsp;&nbsp;项目信息浏览</a></td>
       <td width="100">&nbsp;</td>
       <td width="180" height="35" align="center" background="../image/invest/all_link.jpg" class="fontstyle1"><a href="invest_message_iss.asp" class="channel1">&nbsp;&nbsp;&nbsp;项目信息发布</a></td>
       <td width="117">&nbsp;</td>
     </tr>
     <tr>
