...
<center>
 ...
 <table width="970" border="0" cellspacing="2" cellpadding="2">
  ...
  <div class="right">
  <form name="form1" enctype="multipart/form-data" method="post" action="diagnose_up.asp"> 
   ...
   <tr>
     ...
     <td align="center" background="../image/diagnose6.jpg" width="248" height="122" class="fontstyle1">我已阅读并熟知本声明及相关条款，现提交我的"自"诊断报告！
