 ...
 <tr>
   ...
   <td width="500">
    ...
    <table width="500" border="0" cellspacing="0" cellpadding="0" >
     <tr>
      <td width="78"><a href="../register/register.asp"><img src="../image/reg.jpg" width="78" height="26" border="0"></a></td>
      <td width="66" height="13"><span class="fontstyle1">登录名：</span></td>
      <td width="119"><input name="rname" type="text" size="15" /></td>
      <td width="43"><span class="fontstyle1">密码：</span></td>
      <td width="105"><input name="password" type="password" size="15" /></td>
      <td width="51"><img src="../image/button.jpg" width="50" height="26" style="cursor: hand" onclick="javascript:form1.submit();"></td>
     </tr>
    </table>
    </div>   
    </form>
  ...
  <div class="link">
   <table width="970" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td width="80" height="30" align="center" background="../image/link/3.gif"><span class="fontstyle2"><a href="../series/series.asp" class="channel0">服务系列</a></span></td>
      <td width="80" height="30" align="center" background="../image/link/3.gif"><span class="fontstyle2"><a href="diagnose_brief.asp" class="channel0">"自"诊断</a></span></td>
