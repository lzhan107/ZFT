...
<center>
 <div class="mainstyle">
  ...
  <div class="right">
   <form action="check.asp" method="post" name="reg">
   <table width="610" border="0" cellspacing="12" cellpadding="0">
    ...
    <tr>
      <td colspan="3"  style="font-size:14px;">（说明： "<span style="color:#C8000B;">*</span>"项目，登录名必须由6位以上的数字或字母组成）</td>
    </tr>
    <tr>
      <td colspan="3"> 
        <table align="center" width="530" border="1" bordercolor="#666666" style="border-collapse:collapse;" cellspacing="0" cellpadding="0" class="tablestyle">
         ...
         <tr>
           ...
           <td align="left" ><input type="text" name="rname" size=28><a onClick="reg.submit()"><span style="color:#C8000B; cursor:hand">检验是否可用</span></a></td>
         </tr>
         <tr>
         ...
         <tr>
           ...
           <td align="left" ><input type="password" name="repassword" size=30></td>
         </tr>
         <tr>
           <td align="center"><span style="color:#C8000B;">*</span>业务种类（经营范围） </td>
           <td align="left" ><input type="text" name="kind" size=28></td>
         </tr>
         <tr>
           <td align="center">企业负责人（或法人）姓名</td>
           <td align="left" ><input type="text" name="legalp" size=28></td>
         </tr>
         <tr>
           <td align="center"><span style="color:#C8000B;">*</span>企业地址 </td>
           <td align="left" ><input type="text" name="address" size=28></td>
         </tr>
         <tr>
           <td align="center"><span style="color:#C8000B;">*</span>企业网址 </td>
           <td align="left" ><input type="text" name="website" size=28></td>
         </tr>
         <tr>
           <td align="center">最近一年年营业额 </td>
           <td align="left" ><input type="text" name="amount" size=28></td>
         </tr>
         <tr>
           <td align="center">主要产品</td>
           <td align="left" ><input type="text" name="product" size=28></td>
         </tr>
         <tr>
           <td align="center"><span style="color:#C8000B;">*</span>员工总人数 </td>
           <td align="left" ><input type="text" name="sum" size=28></td>
         </tr>
        <tr>
          <td align="center"><span style="color:#C8000B;">*</span>联系人姓名:</td>
          <td align="left">
            <input type="text" name="lname" size=28>
          </td>
        </tr>
        <tr>
          <td align="center"><span style="color:#C8000B;">*</span>联系人职务:</td>
          <td align="left">
            <input type="text" name="job" size=28>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td align="left">
            <input type="text" name="cellphone" size=28>
          </td>
        </tr>
        <tr>
