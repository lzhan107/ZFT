...
<% 
   ...
   com="Select top 7 ID,theme from 经济新闻"
   comm="Select top 7 ID,theme from 学习活动"
   Set rs=conn.Execute(com, recordsAffected, adcmdtext)
   Set res=conn.Execute(comm, recordsAffected, adcmdtext)
%>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;企业服务一站通!</span></td>
  ...
  <table width="960" height="290" border="0" cellspacing="4" cellpadding="4">
    <tr>
      <td width="430" align="right">
      <table width="415" height="280" border="0" cellspacing="6" cellpadding="6" class="fontstyle1">
       <tr>
         <td width="25">&nbsp;</td>
         <td height="35" width="168" background="image/about4.jpg" align="center">经济新闻</td>
         <td width="162" align="right"><a href="news/news_economic.asp"><img border="0" src="image/news.jpg" width="48" height="22"></a></td>
       </tr>
       <tr><td colspan="3" align="right" valign="top">
        <table width="360" border="1" cellspacing="2" cellpadding="2" bordercolor="#CCCCCC" style="border-collapse:collapse; font-size:13px;">
<%
	      While Not rs.eof
%>        <tr>
            <td width="343" height='30' valign='middle'> &nbsp;◎&nbsp;<a href="news/detail_economic.asp?id=<%= rs("ID") %>" class="channel3"><%=  rs("theme")  %></a></td>
<%            rs.movenext
%>	      </tr>
<%        Wend
%>
      ...
      <td width="20" background=""><div style="border-right:solid #CCC 1px; height:280px;"></div></td>
      <td width="470" align="left">
      <table width="415" height="280" border="0" cellspacing="6" cellpadding="6" class="fontstyle1">
       <tr>
         <td width="8">&nbsp;</td>
         <td height="35" width="168" background="image/about4.jpg" align="center">学习活动动态</td>
         <td width="179" align="right"><a href="news/news_education.asp"><img border="0" src="image/news.jpg" width="48" height="22"></a></td>
       </tr>
       <tr><td width="8">&nbsp;</td>
...
<%
	      While Not res.eof
%>        <tr>
            <td height='30' valign='middle'> &nbsp;◎&nbsp;<a href="news/detail_education.asp?id=<%= res("ID") %>" class="channel3"><%=  res("theme")  %></a></td>
<%            res.movenext
%>	      </tr>
<%        Wend
%>
  ...
  <table width="960" border="0" cellspacing="2" cellpadding="2"class="fontstyle1">
   <tr>
    ...
    <td width="10">&nbsp;</td>
    <td>
    <marquee onMouseOver=this.stop() onMouseOut=this.start() scrollamount=6 direction="right">
