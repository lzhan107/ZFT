...
<center>
 <div class="mainstyle">
  ...
  <div class="right">
<form name="form5" method="post" action="ruanjian_pro.asp">
<table width="610" border="0" cellspacing="12" cellpadding="0">
  <tr>
    <td height="35" colspan="3" align="center">
     <table width="196" border="0" cellspacing="0" cellpadding="0">
      <tr><td align="left" height="38" background="../image/all.jpg"  style="font-size:14px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;软件信息化需求提交</td></tr>
     </table>
   </td>
  </tr>
  <tr>
    <td colspan="3"><p style="font-size:13px;">&nbsp;&nbsp;&nbsp;&nbsp;中服通的软件信息化服务包含信息化规划、战略管理软件、人力资源软件(HR)、客户关系软件CRM)、电子商务软件、企业资源计划（ERP）、业务流程管理（BPR）、供应链物流（SCM)、精益生产管理软件、质量管理软件、知识管理软件（KM）、财会税务软件、项目管理软件（PM）、产品全周期管理(PLM)、办公系统(OA)、企业网站建设、企业资产管理软件、安全监控系统、专业加工制造软件、视频会议等方面系列项目。<br>
&nbsp;&nbsp;&nbsp;&nbsp;如果你有这方面的服务需求，请填写如下表单，并提交给我们，我们将会在第一时间内与你共同探讨系统化解决方案！
  ...
  <tr>
    ...
    <table width="500" border="1" bordercolor="#666666" style="border-collapse:collapse;" cellspacing="0" cellpadding="0" class="tablestyle">
      ...
      <tr>
        ...
        战略管理软件<br>
        <input type="checkbox" name="checkbox16" value="1">
        质量管理软件<br>
        <input type="checkbox" name="checkbox17" value="1">
        财会税务软件<br>
        <input type="checkbox" name="checkbox18" value="1">
        企业网站建设<br>
        <input type="checkbox" name="checkbox19" value="1">
        安全监控系统<br>
        <input type="checkbox" name="checkbox20" value="1">
        视频会议<br>
        <input type="checkbox" name="checkbox21" value="1">
        其它<br>
        </label></td>
  ...
  <tr>
   <td width="250" align="right"><img src="../image/submit.jpg" width="50" height="23" onClick="javascript:form5.submit()"></td>
   <td width="100" align="center">&nbsp;</td>
   <td width="250" align="left"><img src="../image/reset.jpg" width="50" height="23" onClick="javascript:form5.reset()"></td>
  </tr>
</table>
</form>
  </div>
