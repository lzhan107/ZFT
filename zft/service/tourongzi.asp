...
<center>
 <div class="mainstyle">
  ...
  <div class="right">
<form name="form0" method="post" action="tourougzi_pro.asp" onsubmit="return test()">
<table width="610" border="0" cellspacing="12" cellpadding="0">
  <tr>
    <td height="35" colspan="3" align="center">
     <table width="196" border="0" cellspacing="0" cellpadding="0">
      <tr><td align="left" height="38" background="../image/all.jpg"  style="font-size:14px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;投融资需求提交</td></tr>
     </table>
   </td>
  </tr>
  <tr>
    <td colspan="3"><p style="font-size:13px;">&nbsp;&nbsp;&nbsp;&nbsp;中服通的投融资服务包含投融资咨询、商业策划、项目可研、招商引资、上市服务、担保服务、并购重组、投融资顾问等方面系列项目。<br>
&nbsp;&nbsp;&nbsp;&nbsp;如果你有这方面的服务需求，请填写如下表单，并提交给我们，我们将会在第一时间内与你共同探讨系统化解决方案！
  ...
  <tr>
   <td width="250" align="right"><img src="../image/submit.jpg" width="50" height="23" onClick="javascript:form0.submit()"></td>
   <td width="100" align="center">&nbsp;</td>
   <td width="250" align="left"><img src="../image/reset.jpg" width="50" height="23" onClick="javascript:form0.reset()"></td>
  </tr>
</table>
</form>
  </div>
