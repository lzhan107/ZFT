...
<%  comm="Select qname from 广告服务 where qname='"&qname&"'"
	...
	If(str(1)=1 or str(2)=1 or str(3)=1 or str(4)=1 or str(5)=1 or str(6)=1 or str(7)=1 or str(8)=1 or str(9)=1) then
      Dim sqlstr
	  sqlstr = "insert into 广告服务(qname,lname,zhiwu,phone,cellphone,email,guanggaocehua,guanggaozhizuo,guanggaofabu,gongguancehua,gongguanshijianchuanbo,litichuanbozhenghe,baozhuangshejizhizuo,wangzhanshejiyutuiguang,qita,qitajiandanshuoming)" & "values('"&qname&"','"&lname&"','"&zhiwu&"','"&phone&"','"&cellphone&"','"&email&"','"&str(1)&"','"&str(2)&"','"&str(3)&"','"&str(4)&"','"&str(5)&"','"&str(6)&"','"&str(7)&"','"&str(8)&"','"&str(9)&"','"&qitajiandanshuoming&"')"
	  Dim Comm
