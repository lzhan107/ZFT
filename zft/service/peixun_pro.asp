...
<!--#include file="../Database/conn.asp" -->
 <% comm="Select qname from 培训发展 where qname='"&qname&"'"
	...
	If(str(1)=1 or str(2)=1 or str(3)=1 or str(4)=1 or str(5)=1 or str(6)=1 or str(7)=1 or str(8)=1 or str(9)=1 or str(10)=1 or str(11)=1 or str(12)=1 or str(13)=1 or str(14)=1) then
      Dim sql
	  sql="insert into 培训发展(qname,lname,zhiwu,phone,cellphone,email,yuangongsuzhitisheng,yuangongnenglitisheng,tuozhanpeixun,renliziyuan,shichangyingxiao,kehufuwu,caiwuguanli,caigouwuliu,shengchanguanli,zhiliangguanli,xiangmuguanli,xinxihuaguanli,Elearning,qita,qitajiandanshuoming)" & "values('"&qname&"','"&lname&"','"&zhiwu&"','"&phone&"','"&cellphone&"','"&email&"','"&str(1)&"','"&str(2)&"','"&str(3)&"','"&str(4)&"','"&str(5)&"','"&str(6)&"','"&str(7)&"','"&str(8)&"','"&str(9)&"','"&str(10)&"','"&str(11)&"','"&str(12)&"','"&str(13)&"','"&str(14)&"','"&qita&"')"
	  Dim Comm
