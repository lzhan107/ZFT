   ...
   <td width="500">
    ...
    <table width="480" border="0" cellspacing="0" cellpadding="0" class="fontstyle1">
     <tr>
      ...
      <td width="70"><a href="cancel_r.asp"><img src="image/cancel.jpg" width="50" height="24" style="cursor: hand" border="0"></a></td>
     </tr>
    </table>
    </div>   
   </td>
  ...
  <div class="link">
   <table width="970" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td width="50" height="30" align="center" background="image/link/2.gif"><span class="fontstyle2"><a href="index_r.asp" class="channel0">首页</a></span></td>
      ...
      <td width="80" height="30" align="center" background="image/link/3.gif"><span class="fontstyle2"><a href="series/" class="channel0">服务系列</a></span></td>
